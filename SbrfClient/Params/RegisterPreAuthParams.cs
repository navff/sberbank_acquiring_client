...
{
    public class RegisterPreAuthParams
    {
        /// <summary>
        ...
        /// 1) Даже если сумма платежа будет передана в запросе, она не будет списана со счёта
        /// покупателя.
        /// 2) После успешной регистрации заказ сразу переводится в статус REVERSED
        /// (отменён).
        /// </summary>
